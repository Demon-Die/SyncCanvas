...
} from "./chunk-D5X65HKF.js";
import {
  useControlled
} from "./chunk-UYJ6VNTZ.js";
...
var MenuGroupLabel = React15.forwardRef(function MenuGroupLabel2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
...
var InternalBackdrop = React23.forwardRef(function InternalBackdrop2(props, ref) {
  const {
    cutout,
    ...otherProps
  } = props;
...
function useAnchoredPopupScrollLock(enabled, touchOpen, positionerElement, referenceElement) {
  const [touchOpenShouldLockScroll, setTouchOpenShouldLockScroll] = React24.useState(false);
  useIsoLayoutEffect(() => {
...
var MenuPositioner = React25.forwardRef(function MenuPositioner2(componentProps, forwardedRef) {
  var _a;
  const {
    anchor: anchorProp,
  ...
  const previousTriggerRef = React25.useRef(null);
  ...
  return (0, import_jsx_runtime7.jsxs)(MenuPositionerContext.Provider, {
    value: positioner,
    children: [shouldRenderBackdrop && (0, import_jsx_runtime7.jsx)(InternalBackdrop, {
      ref: parent.type === "context-menu" || parent.type === "nested-context-menu" ? parent.context.internalBackdropRef : null,
      inert: inertValue(!open),
      cutout: backdropCutout
    }), (0, import_jsx_runtime7.jsx)(FloatingNode, {
      id: floatingNodeId,
      children: (0, import_jsx_runtime7.jsx)(CompositeList, {
...
var MenuRadioGroupContext = React26.createContext(void 0);
if (true) MenuRadioGroupContext.displayName = "MenuRadioGroupContext";
function useMenuRadioGroupContext() {
  const context = React26.useContext(MenuRadioGroupContext);
  if (context === void 0) {
...
var MenuRadioGroup = React27.memo(React27.forwardRef(function MenuRadioGroup2(componentProps, forwardedRef) {
  const {
    render,
    className,
    value: valueProp,
  ...
  const [labelId, setLabelId] = React27.useState(void 0);
  ...
  return (0, import_jsx_runtime8.jsx)(MenuGroupContext.Provider, {
    value: setLabelId,
    children: (0, import_jsx_runtime8.jsx)(MenuRadioGroupContext.Provider, {
      value: context,
      children: element
    })
  });
...
var MenuRadioItemContext = React28.createContext(void 0);
...
var MenuRadioItem = React29.forwardRef(function MenuRadioItem2(componentProps, forwardedRef) {
  const {
    render,
    className,
    id: idProp,
  ...
  return (0, import_jsx_runtime9.jsx)(MenuRadioItemContext.Provider, {
    value: state,
    children: element
  });
});
...
var MenuRadioItemIndicator = React30.forwardRef(function MenuRadioItemIndicator2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
  ...
  const indicatorRef = React30.useRef(null);
  const {
    transitionStatus,
    setMounted
  } = useTransitionStatus(item.checked);
...
var MenubarContext = React31.createContext(null);
if (true) MenubarContext.displayName = "MenubarContext";
function useMenubarContext(optional) {
  const context = React31.useContext(MenubarContext);
...
function useEnhancedClickHandler(handler) {
  const lastClickInteractionTypeRef = React32.useRef("");
  const handlePointerDown = React32.useCallback((event) => {
  ...
  const handleClick = React32.useCallback((event) => {
    if (event.detail === 0) {
...
function useOpenInteractionType(open) {
  const [openMethod, setOpenMethod] = React34.useState(null);
...
var MenuStore = class _MenuStore extends ReactStore {
  constructor(initialState) {
    super({
      ...
      positionerRef: React35.createRef(),
      popupRef: React35.createRef(),
      typingRef: {
        current: false
      },
      itemDomElements: {
      ...
      triggerFocusTargetRef: React35.createRef(),
      beforeContentFocusGuardRef: React35.createRef(),
...
var MenuSubmenuRootContext = React36.createContext(void 0);
if (true) MenuSubmenuRootContext.displayName = "MenuSubmenuRootContext";
function useMenuSubmenuRootContext() {
  return React36.useContext(MenuSubmenuRootContext);
}
...
var MenuRoot = fastComponent(function MenuRoot2(props) {
  ...
  const parentFromContext = React37.useMemo(() => {
  ...
  const floatingParentNodeId = store.useState("floatingParentNodeId");
  const openEventRef = React37.useRef(null);
  const allowOutsidePressDismissalRef = React37.useRef(parent.type !== "context-menu");
  const allowOutsidePressDismissalTimeout = useTimeout();
  const allowTouchToCloseRef = React37.useRef(true);
  ...
  React37.useImperativeHandle(ctx == null ? void 0 : ctx.positionerRef, () => positionerElement, [positionerElement]);
  React37.useImperativeHandle(ctx == null ? void 0 : ctx.actionsRef, () => ({
    setOpen
  }), [setOpen]);
  ...
  const setActiveIndex = React37.useCallback((index) => {
  ...
  const onTyping = React37.useCallback((nextTyping) => {
  ...
  const activeTriggerProps = React37.useMemo(() => {
  ...
  const inactiveTriggerProps = React37.useMemo(() => {
  ...
  const popupProps = React37.useMemo(() => mergeProps(FOCUSABLE_POPUP_PROPS, {
    id: floatingId,
    role: "menu",
    "aria-labelledby": activeTriggerElement == null ? void 0 : activeTriggerElement.id,
    onMouseMove() {
      store.set("allowMouseEnter", true);
      if (parent.type === "menu") {
        store.set("hoverEnabled", false);
  ...
  const content = (0, import_jsx_runtime10.jsx)(MenuRootContext.Provider, {
    value: context,
  ...
  if (parent.type === void 0 || parent.type === "context-menu") {
    return (0, import_jsx_runtime10.jsx)(FloatingTree, {
      externalTree: floatingTreeRoot,
      children: content
    });
  }
...
function MenuSubmenuRoot(props) {
  ...
  return (0, import_jsx_runtime11.jsx)(MenuSubmenuRootContext.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime11.jsx)(MenuRoot, {
      ...props
    })
  });
}
...
function useCompositeItem(params = {}) {
  ...
  const compositeProps = React39.useMemo(() => ({
...
function useTriggerFocusGuards(store, triggerElementRef) {
  const preFocusGuardRef = React40.useRef(null);
...
function useMixedToggleClickHandler(params) {
  ...
  const ignoreClickRef = React41.useRef(false);
...
var MenuTrigger = fastComponentRef(function MenuTrigger2(componentProps, forwardedRef) {
  ...
  const floatingTreeRoot = React42.useMemo(() => {
  ...
  const localInteractionProps = React42.useMemo(() => mergeProps(focus.reference, click.reference), [focus.reference, click.reference]);
  ...
  if (isInMenubar) {
    return (0, import_jsx_runtime12.jsx)(CompositeItem, {
      tag: "button",
      render,
      className,
      style,
  ...
  if (isOpenedByThisTrigger) {
    return (0, import_jsx_runtime12.jsxs)(React42.Fragment, {
      children: [(0, import_jsx_runtime12.jsx)(FocusGuard, {
        ref: preFocusGuardRef,
        onFocus: handlePreFocusGuardFocus
      }, `${thisTriggerId}-pre-focus-guard`), (0, import_jsx_runtime12.jsx)(React42.Fragment, {
        children: element
      }, thisTriggerId), (0, import_jsx_runtime12.jsx)(FocusGuard, {
        ref: store.context.triggerFocusTargetRef,
        onFocus: handleFocusTargetFocus
      }, `${thisTriggerId}-post-focus-guard`)]
    });
  }
  return (0, import_jsx_runtime12.jsx)(React42.Fragment, {
    children: element
  }, thisTriggerId);
});
...
function useStickIfOpen(open, openReason) {
  ...
  const [stickIfOpen, setStickIfOpen] = React42.useState(false);
  useIsoLayoutEffect(() => {
...
var MenuViewport = React43.forwardRef(function MenuViewport2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
...
var Separator = React44.forwardRef(function SeparatorComponent(componentProps, forwardedRef) {
  const {
    className,
    render,
...
// node_modules/@base-ui/react/esm/menu/submenu-trigger/MenuSubmenuTrigger.js
var MenuSubmenuTrigger = React45.forwardRef(function MenuSubmenuTrigger2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
  ...
  const registerTrigger = React45.useCallback((element2) => {
  ...
  const handleTriggerElementRef = React45.useCallback((el) => {
