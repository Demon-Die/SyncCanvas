...
var require_use_sync_external_store_shim_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    (function() {
      ...
      var React45 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is, useState12 = React45.useState, useEffect10 = React45.useEffect, useLayoutEffect2 = React45.useLayoutEffect, useDebugValue2 = React45.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
...
var require_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
      var React45 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore2 = shim.useSyncExternalStore, useRef24 = React45.useRef, useEffect10 = React45.useEffect, useMemo20 = React45.useMemo, useDebugValue2 = React45.useDebugValue;
...
function isHoverOpenEvent(openEventType) {
  return (openEventType == null ? void 0 : openEventType.includes("mouse")) && openEventType !== "mousedown";
}
...
var FloatingPortal = React6.forwardRef(function FloatingPortal2(componentProps, forwardedRef) {
  ...
  const focusInsideDisabledRef = React6.useRef(false);
...
function useDismiss(context, props = {}) {
  ...
  const hasBlockingChild = useStableCallback((bubbleKey) => {
    ...
    return children.some((child) => {
      var _a2;
      return ((_a2 = child.context) == null ? void 0 : _a2.open) && !child.context.dataRef.current[bubbleKey];
    });
  });
...
function useSyncedFloatingRootContext(options) {
  ...
  const internalStoreRef = React17.useRef(null);
...
function usePopupStore(externalStore, createStore, treatPopupAsFloatingElement = false) {
  ...
  const internalStoreRef = React18.useRef(null);
...
function setOpenTriggerState(state, open, trigger) {
  const triggerId = (trigger == null ? void 0 : trigger.id) ?? null;
  if (triggerId || open) {
...
var popupIdSelector = createSelector((state) => {
  var _a;
  const popupId = ((_a = state.popupElement) == null ? void 0 : _a.id) ?? state.floatingId;
...
function useFloating2(options = {}) {
  ...
  const open = store.useState("open");
  const floatingId = store.useState("floatingId");
  const [positionReference, setPositionReferenceRaw] = React19.useState(null);
  const [localDomReference, setLocalDomReference] = React19.useState(void 0);
  const [localFloatingElement, setLocalFloatingElement] = React19.useState(void 0);
  const domReferenceRef = React19.useRef(null);
  const tree = useFloatingTree(externalTree);
  const storeElements = React19.useMemo(() => ({
...
function useFocus(context, props = {}) {
  ...
  const blockFocusRef = React20.useRef(false);
  const blockedReferenceRef = React20.useRef(null);
  const keyboardModalityRef = React20.useRef(true);
  const timeout = useTimeout();
  React20.useEffect(() => {
...
function useHoverFloatingInteraction(context, parameters = {}) {
  ...
  const isHoverOpen = useStableCallback(() => {
    var _a;
    return isHoverOpenEvent((_a = dataRef.current.openEvent) == null ? void 0 : _a.type);
  });
  ...
  useIsoLayoutEffect(() => {
    ...
    if (open && ((_a = instance.handleCloseOptions) == null ? void 0 : _a.blockPointerEvents) && isHoverOpen() && isElement(domReferenceElement) && floatingElement) {
      ...
      const scopeElement = ((_e = (_d = instance.handleCloseOptions) == null ? void 0 : _d.getScope) == null ? void 0 : _e.call(_d)) ?? cachedScopeElement ?? parentScopeElement ?? ref.closest("[data-rootownerid]") ?? doc.body;
...
function useHoverReferenceInteraction(context, props = {}) {
  ...
  const tree = useFloatingTree(externalTree);
  const instance = useHoverInteractionSharedState(store);
  const isHoverCloseActiveRef = React22.useRef(false);
  ...
  const checkShouldOpen = useStableCallback(() => {
    var _a2;
    return ((_a2 = shouldOpenRef.current) == null ? void 0 : _a2.call(shouldOpenRef)) !== false;
  });
  ...
  React22.useEffect(() => cleanupMouseMoveHandler, [cleanupMouseMoveHandler]);
  React22.useEffect(() => {
    if (!enabled) {
      return void 0;
    }
...
var TooltipRoot = fastComponent(function TooltipRoot2(props) {
  ...
  return (0, import_jsx_runtime7.jsxs)(TooltipRootContext.Provider, {
    value: store,
    children: [shouldRenderInteractions && (0, import_jsx_runtime7.jsx)(TooltipInteractions, {
      store,
      disabled,
      trackCursorAxis
...
function TooltipInteractions({
  ...
  const activeTriggerProps = React27.useMemo(() => mergeProps(clientPoint.reference, dismiss.reference), [clientPoint.reference, dismiss.reference]);
  const inactiveTriggerProps = React27.useMemo(() => mergeProps(clientPoint.trigger, dismiss.trigger), [clientPoint.trigger, dismiss.trigger]);
  const popupProps = React27.useMemo(() => mergeProps(FOCUSABLE_POPUP_PROPS, clientPoint.floating, dismiss.floating), [clientPoint.floating, dismiss.floating]);
...
var TooltipTrigger = fastComponentRef(function TooltipTrigger2(componentProps, forwardedRef) {
  ...
  const isNestedTriggerHoveredRef = React29.useRef(false);
...
function useDirection() {
  const context = React34.useContext(DirectionContext);
...
var TooltipPositioner = React36.forwardRef(function TooltipPositioner2(componentProps, forwardedRef) {
  const {
    render,
    className,
    anchor,
...
var TooltipPopup = React37.forwardRef(function TooltipPopup2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
...
var TooltipArrow = React38.forwardRef(function TooltipArrow2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
...
var TooltipProvider = function TooltipProvider2(props) {
  ...
  const delayValue = React39.useMemo(() => ({
    open: delay,
    close: closeDelay
  }), [delay, closeDelay]);
...
function usePopupAutoResize(parameters) {
  ...
  const committedDimensionsRef = React41.useRef(null);
  const liveDimensionsRef = React41.useRef(null);
  const isInitialRenderRef = React41.useRef(true);
  const restoreAnchoringStylesRef = React41.useRef(NOOP);
  const onMeasureLayout = useStableCallback(onMeasureLayoutParam);
  const onMeasureLayoutComplete = useStableCallback(onMeasureLayoutCompleteParam);
  const anchoringStyles = React41.useMemo(() => {
...
function usePopupViewport(parameters) {
  ...
  if (!isTransitioning) {
    ...
    childrenToRender = (0, import_jsx_runtime13.jsxs)(React43.Fragment, {
...
var TooltipViewport = React44.forwardRef(function TooltipViewport2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
