...
var require_use_sync_external_store_shim_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    (function() {
      ...
      var React31 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is, useState12 = React31.useState, useEffect10 = React31.useEffect, useLayoutEffect2 = React31.useLayoutEffect, useDebugValue2 = React31.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
...
var require_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
      var React31 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore2 = shim.useSyncExternalStore, useRef22 = React31.useRef, useEffect10 = React31.useEffect, useMemo17 = React31.useMemo, useDebugValue2 = React31.useDebugValue;
  ...
  useIsoLayoutEffect(() => {
    ...
    function getReturnElement() {
      ...
      if (typeof resolvedReturnFocusValue === "boolean") {
        if (domReference == null ? void 0 : domReference.isConnected) {
          return domReference;
        }
        return getPreviouslyFocusedElement() || null;
      }
      const fallback = (domReference == null ? void 0 : domReference.isConnected) ? domReference : getPreviouslyFocusedElement();
...
function useStoreR19(store, selector, a1, a2, a3) {
  const getSelection = React10.useCallback(() => selector(store.getSnapshot(), a1, a2, a3), [store, selector, a1, a2, a3]);
...
var ReactStore = class extends Store {
  ...
  useSyncedValues(statePart) {
    const store = this;
    if (true) {
      React11.useDebugValue(statePart, (p) => Object.keys(p));
      const keys = React11.useRef(Object.keys(statePart)).current;
...
function usePopupStore(externalStore, createStore, treatPopupAsFloatingElement = false) {
  ...
  const internalStoreRef = React15.useRef(null);
...
function useFloating2(options = {}) {
  ...
  const [localFloatingElement, setLocalFloatingElement] = React22.useState(void 0);
  const domReferenceRef = React22.useRef(null);
  const tree = useFloatingTree(externalTree);
  const storeElements = React22.useMemo(() => ({
...
function usePopupAutoResize(parameters) {
  ...
  const committedDimensionsRef = React28.useRef(null);
  const liveDimensionsRef = React28.useRef(null);
  const isInitialRenderRef = React28.useRef(true);
  const restoreAnchoringStylesRef = React28.useRef(NOOP);
  const onMeasureLayout = useStableCallback(onMeasureLayoutParam);
  const onMeasureLayoutComplete = useStableCallback(onMeasureLayoutCompleteParam);
  const anchoringStyles = React28.useMemo(() => {
...
function usePopupViewport(parameters) {
  ...
  const capturedNodeRef = React30.useRef(null);
  const [previousContentNode, setPreviousContentNode] = React30.useState(null);
  const [newTriggerOffset, setNewTriggerOffset] = React30.useState(null);
  const currentContainerRef = React30.useRef(null);
  const previousContainerRef = React30.useRef(null);
  const onAnimationsFinished = useAnimationsFinished(currentContainerRef, true, false);
  const cleanupFrame = useAnimationFrame();
  const [previousContentDimensions, setPreviousContentDimensions] = React30.useState(null);
  const [showStartingStyleAttribute, setShowStartingStyleAttribute] = React30.useState(false);
  useIsoLayoutEffect(() => {
  ...
  const lastHandledTriggerRef = React30.useRef(null);
  useIsoLayoutEffect(() => {
  ...
  if (!isTransitioning) {
    ...
    childrenToRender = (0, import_jsx_runtime8.jsxs)(React30.Fragment, {
...
function usePopupContentKey(activeTriggerId, payload) {
  const [contentKey, setContentKey] = React30.useState(0);
  const previousActiveTriggerIdRef = React30.useRef(activeTriggerId);
  const previousPayloadRef = React30.useRef(payload);
  const pendingPayloadUpdateRef = React30.useRef(false);
  useIsoLayoutEffect(() => {
...
use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-5LNE7H6L.js.map
